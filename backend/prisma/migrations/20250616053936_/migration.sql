/*
  ...
  - Added the required column `userId` to the `KanbanBoard` table without a default value. This is not possible if the table is not empty.
  - Added the required column `userId` to the `Todo` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "KanbanBoard" ADD COLUMN     "userId" TEXT NOT NULL;
